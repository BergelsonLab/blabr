...
Items include the vocabulary checklist items, gesture items, and
sentence items. These two csv (for WG and WS) was downloaded from
WebCDI's GitHub
[repo](https://github.com/langcog/web-cdi/tree/master/webcdi/cdi_form_csv/cdi_forms),
