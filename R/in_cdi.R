...
ws_summary_cols <- c("Words Produced", "Words Produced Percentile-sex", "Words Produced Percentile-both", # these three cols only exist if WS output was renamed to match WG
                     "Total Produced", "Total Produced Percentile-sex", "Total Produced Percentile-both", 
